...
ActiveRecord::Schema.define(version: 2021_01_16_082916) do
  ...
  create_table "spree_checks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
